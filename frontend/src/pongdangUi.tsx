...
// 핸드오프 디자인(Pongdang 디자인 시스템 v2)의 공용 표시 요소입니다. 오늘 ·
// 홈 · 추천 세 화면이 같은 아이콘 세트와 같은 등급/데이터 상태 표기를 쓰도록
// TSX 만 공유합니다. CSS 는 공유하지 않습니다 -- 화면별 CSS 파일이 각자의
// 페이지 루트 클래스(.today-page / .home-page / .recommend-page) 아래에서
// 아래 pd-* 클래스를 정의하고 --pd-* 토큰도 각자의 루트에 선언합니다.
//
