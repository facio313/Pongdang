    ...
    >
        <div className="pd-card">
          <div className="rc-card-top">
            ...
            <StateChip kind={saved ? "live" : "uncollected"} />
          </div>
    ...
    >
        {phase === "tags" && (
          <>
            ...
            <div className="rc-stack">
              <button type="button" className="pd-primary" onClick={onNext}>
        ...
        {phase === "cards" && (
          <>
            ...
            <button type="button" className="pd-secondary" onClick={onRestart}>
              다시 고르기
            </button>
          </>
        )}
