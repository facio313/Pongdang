...
export const placesMessages: Record<string, MessageTranslations> = {
  ...
  "홈페이지": ["Website", "网站", "ウェブサイト"],
  "소개": ["About this place", "景点简介", "スポット紹介"],
  "정보 미제공": ["Not provided", "未提供信息", "情報提供なし"],
  "수집 실패": ["Collection failed", "收集失败", "収集失敗"],
  "상세정보 연결 없음": ["No linked details", "无关联详情", "関連する詳細情報なし"],
  "수집 대상 아님": ["Not covered", "不在收集范围", "収集対象外"],
  "미수집": ["Not yet collected", "尚未收集", "未収集"],
  "제공처에서 상세정보를 제공하지 않았습니다.": ["The provider has not supplied detailed information.", "提供方未提供详细信息。", "提供元から詳細情報は提供されていません。"],
  "상세정보 수집에 실패했습니다.": ["Detailed information could not be collected.", "详细信息收集失败。", "詳細情報の収集に失敗しました。"],
  "이 장소와 연결된 관광 상세정보가 없습니다.": ["No tourism details are linked to this place.", "此地点没有关联的旅游详细信息。", "この場所に関連する観光詳細情報がありません。"],
  "이 장소는 상세정보 수집 대상이 아닙니다.": ["Detailed information collection does not cover this place.", "此地点不在详细信息收集范围内。", "この場所は詳細情報の収集対象ではありません。"],
  "상세정보를 아직 수집하지 않았습니다.": ["Detailed information has not been collected yet.", "尚未收集详细信息。", "詳細情報はまだ収集されていません。"],
  "저장된 상세정보를 조회하고 있습니다.": ["Loading stored details.", "正在查询已保存的详细信息。", "保存済みの詳細情報を読み込んでいます。"],
  "저장된 상세정보를 불러오지 못했습니다.": ["Could not load stored details.", "无法加载已保存的详细信息。", "保存済みの詳細情報を読み込めませんでした。"],
  "최신 상세정보 수집에 실패하여 이전에 저장한 정보를 표시합니다.": ["The latest collection failed; previously saved details are shown.", "最新信息收集失败，当前显示之前保存的信息。", "最新情報の収集に失敗したため、以前に保存した情報を表示しています。"],
  "변경된 상세정보의 수집을 기다리는 동안 이전에 저장한 정보를 표시합니다.": ["Previously saved details are shown while updated information awaits collection.", "正在等待收集变更后的详细信息，当前显示之前保存的信息。", "変更された詳細情報の収集を待つ間、以前に保存した情報を表示しています。"],
  "추가 상세정보 {count}개": ["{count} more details", "另外 {count} 项详细信息", "追加の詳細情報 {count} 件"],
  "출처: {provider}": ["Source: {provider}", "来源：{provider}", "出典：{provider}"],
  "수집일: {date}": ["Collected: {date}", "收集时间：{date}", "収集日時：{date}"],
  "원천 수정일: {date}": ["Provider updated: {date}", "来源更新时间：{date}", "提供元の更新日時：{date}"],
  "개장일은 계절별 개장 기간과 다릅니다. 저장된 안내의 적용 시기와 최신 운영 여부는 방문 전 확인해 주세요.": ["The opening date differs from seasonal opening periods. Check the applicable dates and current operation before visiting.", "开业日期与季节性开放期间不同。出行前请确认已保存信息的适用日期和最新运营情况。", "開業日は季節ごとの営業期間とは異なります。訪問前に案内の対象期間と最新の営業状況をご確認ください。"],
  "직선거리": ["Straight-line distance", "直线距离", "直線距離"],
  "기준: {name}": ["From: {name}", "起点：{name}", "基準：{name}"],
  "장소 좌표가 없어 거리를 계산할 수 없습니다.": ["Distance cannot be calculated without this place's coordinates.", "缺少地点坐标，无法计算距离。", "場所の座標がないため距離を計算できません。"],
  "좌표로 계산한 직선거리이며 도로 이동거리가 아닙니다.": ["Calculated from coordinates as a straight-line distance, not a road distance.", "此距离由坐标计算，为直线距离，并非道路行驶距离。", "座標から計算した直線距離です。道路での移動距離ではありません。"],
  "현재 위치 확인 중…": ["Finding your location…", "正在确认当前位置…", "現在地を確認中…"],
  "현재 위치로 거리 보기": ["Show distance from my location", "查看距当前位置的距离", "現在地からの距離を見る"],
  "현재 위치를 확인하지 못했습니다. 위치 권한을 확인해 주세요.": ["Could not determine your location. Check location permissions.", "无法确认当前位置，请检查位置权限。", "現在地を確認できませんでした。位置情報の権限をご確認ください。"],
  "운영 안내와 대표 사진은 수집해 저장한 정보가 있는 장소에 표시합니다. 장소를 고르면 상세정보와 물놀이 조건을 확인할 수 있습니다.": ["Opening information and photos are shown when collected and stored. Select a place to see its details and water activity conditions.", "已收集并保存信息的地点会显示运营信息和代表照片。选择地点可查看详情和水上活动条件。", "収集して保存した情報がある場所には営業案内と代表写真を表示します。スポットを選ぶと詳細情報と水遊びの条件を確認できます。"],
  "같은 분류의 장소 · 직선거리순": ["Same category · By straight-line distance", "同类地点 · 按直线距离排序", "同じ分類の場所・直線距離順"],
  "현재 목록의 같은 분류 장소를 표시합니다. 거리는 이 명소의 좌표를 기준으로 계산한 직선거리입니다.": ["Showing places in the same category from the current list. Distances are straight-line distances from this place's coordinates.", "显示当前列表中的同类地点。距离为以此景点坐标为起点计算的直线距离。", "現在の一覧から同じ分類の場所を表示しています。距離はこのスポットの座標を基準に計算した直線距離です。"],
  "분류 미확인": [
    "Category unknown",
    "分类未确认",
    "分類未確認"
